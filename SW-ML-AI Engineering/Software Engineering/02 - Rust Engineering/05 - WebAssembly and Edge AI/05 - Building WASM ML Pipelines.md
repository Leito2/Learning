...
Build a complete WASM ML pipeline for real-time audio classification. The pipeline processes audio chunks, extracts features (MFCCs, spectrograms), runs inference, and streams results—all without blocking the UI.

### Functional Requirements

1. Process audio in 100ms chunks with <50ms latency
2. Support multiple model architectures (CNN, RNN, Transformer)
3. Stream results in real-time with progress indicators
4. Cache processed features for common audio patterns
5. Provide graceful degradation for low-power devices
6. Export results in multiple formats (JSON, CSV, visualization)

### Main Components

- **AudioProcessor**: MFCC and spectrogram extraction
- **FeatureCache**: LRU cache for repeated patterns
- **InferenceEngine**: Multi-model orchestration
- **ResultStreamer**: Progressive result delivery
- **MemoryManager**: Pool-based allocation
- **ProgressReporter**: Real-time UI updates
...
- UI responsiveness: No jank (>60fps)

### References

- [WebAssembly Component Model](https://github.com/WebAssembly/component-model)
- [WASM Threads Proposal](https://github.com/WebAssembly/threads)
- [Spotify's Audio ML](https://engineering.atspotify.com/)
