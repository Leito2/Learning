...
Build a performance benchmarking suite that compares native Rust, WASM, and JavaScript implementations of common algorithms. The suite generates visual reports showing when each technology is most appropriate.

### Functional Requirements

1. Benchmark 10+ algorithm categories (math, string, crypto, etc.)
2. Generate HTML reports with interactive charts
3. Test across multiple browser environments
4. Measure cold start, throughput, and memory usage
5. Compare optimized vs unoptimized WASM builds
6. Export results in JSON and CSV formats

### Main Components

- **Benchmark Runner**: Criterion-based native benchmarks
- **WASM Test Suite**: wasm-bindgen-test browser tests
- **Report Generator**: Chart.js-powered HTML reports
- **Memory Profiler**: Allocation tracking via wee_alloc
- **CI Integration**: Automated regression detection

### Success Metrics

- Benchmark coverage: 10+ algorithm categories
- Report generation: <5 seconds
- Statistical significance: 95% confidence intervals
- Memory measurement accuracy: ±1MB
- Browser compatibility: Chrome, Firefox, Safari

### References

- [Criterion.rs Documentation](https://bheisler.github.io/criterion.rs/book/)
- [WebAssembly Performance](https://v8.dev/blog/wasm-code-cache)
- [wasm-bindgen-test Guide](https://rustwasm.github.io/docs/wasm-bindgen/wasm-bindgen-test/)
- [1Password WASM Case Study](https://1password.com/blog/webassembly)
